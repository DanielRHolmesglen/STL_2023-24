...
Shader "Shader Forge/Stars" {
    Properties {
        ...
        _StarColor2 ("StarColor2", Color) = (0.9294118,0.6719356,0.4268423,1)
        _StarColor1 ("StarColor1", Color) = (0.9607843,0.8396163,0.6392157,1)
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_6941 = float2((i.uv0.r+node_1229+node_8839),((node_9842.r*_Speed)+i.uv0.g));
...
////// Lighting:
////// Emissive:
                float3 emissive = lerp(_StarColor1.rgb,_StarColor2.rgb,(node_8267.r+node_9406.b));
