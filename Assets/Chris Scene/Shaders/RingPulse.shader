...
Shader "Shader Forge/RingPulse" {
    Properties {
        ...
        _MovementSpeed ("MovementSpeed", Range(0, 10)) = 10
...
////// Emissive:
                ...
                float node_2914 = ((sin((node_7347.r*_MovementSpeed))*length((i.uv0*2.0+-1.0)))-_Radius); // Length went into here prior
