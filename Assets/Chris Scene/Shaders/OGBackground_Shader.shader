...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:False,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:3138,x:33509,y:32237,varname:node_3138,prsc:2|emission-967-OUT;n:type:ShaderForge.SFN_Time,id:7032,x:32609,y:32644,varname:node_7032,prsc:2;n:type:ShaderForge.SFN_Tex2dAsset,id:6884,x:32984,y:32578,ptovrint:False,ptlb:Texture Image,ptin:_TextureImage,varname:_TextureImage,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:7e36f2ea06207da4d8c25ff499602401,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:3846,x:33256,y:32538,varname:node_3846,prsc:2,tex:7e36f2ea06207da4d8c25ff499602401,ntxv:2,isnm:False|UVIN-7391-OUT,TEX-6884-TEX;n:type:ShaderForge.SFN_Add,id:6639,x:32958,y:32771,varname:node_6639,prsc:2|A-8412-OUT,B-3094-V;n:type:ShaderForge.SFN_Multiply,id:8412,x:32805,y:32644,varname:node_8412,prsc:2|A-7032-TSL,B-8106-OUT;n:type:ShaderForge.SFN_TexCoord,id:3094,x:32609,y:32894,varname:node_3094,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Append,id:7391,x:33108,y:32903,varname:node_7391,prsc:2|A-3094-U,B-6639-OUT;n:type:ShaderForge.SFN_Multiply,id:967,x:33268,y:32338,varname:node_967,prsc:2|A-3735-RGB,B-3846-RGB;n:type:ShaderForge.SFN_ValueProperty,id:3186,x:32535,y:32556,ptovrint:False,ptlb:Speed,ptin:_Speed,varname:_Speed,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:12;n:type:ShaderForge.SFN_Color,id:3735,x:32984,y:32334,ptovrint:False,ptlb:Color,ptin:_Color,varname:_Color,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.8117647,c2:0.8,c3:0.2431373,c4:1;n:type:ShaderForge.SFN_Multiply,id:8106,x:32704,y:32470,varname:node_8106,prsc:2|A-697-OUT,B-3186-OUT;n:type:ShaderForge.SFN_Vector1,id:697,x:32535,y:32455,varname:node_697,prsc:2,v1:1;proporder:6884-3186-3735;pass:END;sub:END;*/
...
////// Emissive:
                ...
                float2 node_7391 = float2(i.uv0.r,((node_7032.r*(1.0*_Speed))+i.uv0.g));
